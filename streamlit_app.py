...
if submitted:
    ...
    if input_text:
        ...
        st.error("⚠️ Silakan masukkan deskripsi terlebih dahulu.")
...
if st.session_state.analysis_done:
    ...
    if budget is None:
        st.warning("⚠️ Tidak ada budget yang ditemukan.")
    else:
        ...
        if st.session_state.required_docs:
            ...
            if doc_choice:
                ...
                if chosen_doc:
                    ...
                    st.warning(f"⚠️ Tidak ada dokumen yang cocok dengan '{doc_choice}'.")

# --- Bagian Bawah: Penampil PDF (hanya muncul jika PDF dipilih) ---
if st.session_state.selected_pdf_path:
    st.write("---")
    st.subheader("👁️ Pratinjau Dokumen")
